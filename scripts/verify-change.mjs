...
const commands = [
  ...
  { cwd: 'frontend', command: 'node', args: ['--experimental-strip-types', '--test', 'test/auditComponentUsage.test.ts', 'test/responseContract.test.ts', 'test/workOrderApi.test.ts', 'test/listHelpers.test.ts', 'test/detailNeighbors.test.ts', 'test/detailNeighborNavCompact.test.mjs', 'test/workOrderDetailNeighborPlacement.test.mjs', 'test/designSystemDetailNeighborUsage.test.mjs', 'test/detailReturnLabel.test.mjs', 'test/templatePageState.test.mjs', 'test/templateDrawerTable.test.mjs', 'test/overlayTemplateDemo.test.mjs', 'test/statusChangeAction.test.mjs', 'test/detailStatusPlacement.test.mjs', 'test/obsoleteStatusFlowAction.test.mjs', 'test/aiSemanticRules.test.mjs', 'test/routerFutureFlag.test.mjs', 'test/viteChunkSplitting.test.mjs', 'test/formPageDateContract.test.mjs', 'test/operatorIdentityPayload.test.mjs'] },
