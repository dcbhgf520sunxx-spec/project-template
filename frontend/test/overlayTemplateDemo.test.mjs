...
test('页面模式的弹窗抽屉区域接入真实 OverlayTemplateDemo', () => {
  assert.ok(workbenchSource.includes("import { OverlayTemplateDemo } from './demos/OverlayTemplateDemo'"));
  assert.ok(workbenchSource.includes("if (title === '弹窗 / 抽屉') return <OverlayTemplateDemo />"));
});
